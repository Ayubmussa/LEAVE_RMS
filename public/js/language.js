document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        en: {
            ...
            'announcements-description': 'Latest announcements from administrators:',
            'dining-menu': 'Dining Menu',
            'dining-menu-description': 'Dining menu and meal schedules:',
        ...
        tr: {
            ...
            'announcements-description': 'Yöneticilerden en son duyurular:',
            'dining-menu': 'Yemek Menüsü',
            'dining-menu-description': 'Yemek menüsü ve öğün saatleri:',
            
            // Tour translations
            'tour-notifications-title': 'Bildirim Merkezi',
            'tour-notifications-content': 'Zil simgesine tıklayarak RMS, İzin Portalı, SIS ve LMS dahil tüm bağlı platformlarınızdan bildirimlerinizi görüntüleyin.',
            ...
            'tour-dining-menu-title': 'Yemek Menüsü',
            'tour-dining-menu-content': 'Bugünün yemek menüsünü ve öğün saatlerini kontrol edin. Kahvaltı ve öğle yemeği saatleri dahil tam detayları görmek için karta tıklayın.',
            'tour-announcements-title': 'Duyurular',
            'tour-announcements-content': 'Yöneticilerden en son duyurularla güncel kalın. Tam detayları okumak için herhangi bir duyuruya tıklayın.',
        ...
        fr: {
            ...
            'announcements-description': 'Dernières annonces des administrateurs :',
            'dining-menu': 'Menu de Restaurant',
            'dining-menu-description': 'Menu du restaurant et horaires des repas :',
            
            // Tour translations
            'tour-notifications-title': 'Centre de Notifications',
            'tour-notifications-content': 'Cliquez sur l\'icône de cloche pour voir vos notifications de toutes les plateformes connectées, y compris RMS, Portail de Congés, SIS et LMS.',
            ...
            'tour-dining-menu-title': 'Menu de Restaurant',
            'tour-dining-menu-content': 'Consultez le menu du restaurant d\'aujourd\'hui et les horaires des repas. Cliquez sur la carte pour voir tous les détails, y compris les heures du petit-déjeuner et du déjeuner.',
            'tour-announcements-title': 'Annonces',
            'tour-announcements-content': 'Restez à jour avec les dernières annonces des administrateurs. Cliquez sur n\'importe quelle annonce pour lire tous les détails.',
        ...
        ru: {
            ...
            'announcements-description': 'Последние объявления от администраторов:',
            'dining-menu': 'Меню столовой',
            'dining-menu-description': 'Меню столовой и расписание приемов пищи:',
            
            // Tour translations
            'tour-notifications-title': 'Центр Уведомлений',
            'tour-notifications-content': 'Нажмите на значок колокольчика, чтобы просмотреть уведомления со всех подключенных платформ, включая RMS, Портал отпусков, SIS и LMS.',
            ...
            'tour-dining-menu-title': 'Меню Ресторана',
            'tour-dining-menu-content': 'Проверьте сегодняшнее меню ресторана и расписание приемов пищи. Нажмите на карточку, чтобы увидеть полные детали, включая время завтрака и обеда.',
            'tour-announcements-title': 'Объявления',
            'tour-announcements-content': 'Будьте в курсе последних объявлений от администраторов. Нажмите на любое объявление, чтобы прочитать полные детали.',
        ...
        ar: {
            ...
            'announcements-description': 'أحدث الإعلانات من المديرين:',
            'dining-menu': 'قائمة الطعام',
            'dining-menu-description': 'قائمة الطعام وجداول الوجبات:',
            
            // Tour translations
            'tour-notifications-title': 'مركز الإشعارات',
            'tour-notifications-content': 'انقر على أيقونة الجرس لعرض إشعاراتك من جميع المنصات المتصلة بما في ذلك RMS، بوابة الإجازات، SIS و LMS.',
            ...
            'tour-dining-menu-title': 'قائمة الطعام',
            'tour-dining-menu-content': 'تحقق من قائمة الطعام اليومية وجداول الوجبات. انقر على البطاقة لعرض التفاصيل الكاملة بما في ذلك أوقات الإفطار والغداء.',
            'tour-announcements-title': 'الإعلانات',
            'tour-announcements-content': 'ابق على اطلاع بآخر الإعلانات من المسؤولين. انقر على أي إعلان لقراءة التفاصيل الكاملة.',
